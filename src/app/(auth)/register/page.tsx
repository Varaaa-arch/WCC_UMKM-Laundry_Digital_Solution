            ...
            <motion.div variants={item(5)} initial="hidden" animate="visible">
              ...
              <div className="relative">
                <input type={showConfirm ? "text" : "password"} required placeholder="••••••••"
                  ...
                  className={`w-full px-4 py-3 pr-12 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-sm ${confirm && password !== confirm ? 'border-red-400' : 'border-gray-200'}`} />
